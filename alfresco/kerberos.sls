...
kerberos-block-replace:
  file.blockreplace:
    ...
    - content: |
        ...
        kerberos.authentication.cifs.configEntryName={{ salt['pillar.get']('alfresco:auth:kerberos:cifs_configEntryName', 'AlfrescoCIFS') }}
        kerberos.authentication.http.configEntryName={{ salt['pillar.get']('alfresco:auth:kerberos:http_configEntryName', 'AlfrescoHTTP') }}
