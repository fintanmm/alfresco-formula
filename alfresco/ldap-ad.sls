...
ldap-ad-block-replace:
  file.blockreplace:
    - name: {{ alfresco.tomcat_dir }}/shared/classes/alfresco-global.properties
    - marker_start: "# LDAP AD : salt managed zone"
    - marker_end: "# LDAP AD ENDS : salt managed zone --"
    - content: |
...
ldap-ad-sync block-replace:
  file.blockreplace:
    - name: {{ alfresco.tomcat_dir }}/shared/classes/alfresco-global.properties
    - marker_start: "# LDAP AD SYNCHRONIZATION : salt managed zone"
    - marker_end: "# LDAP AD SYNCHRONIZATION ENDS : salt managed zone --"
    - content: |
